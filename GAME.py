...
female_user_img = pygame.image.load("Resources/Images/_female_character_animation.png")
...
def leaderboard():
    ...
    y_offset = 307  # starting Y position to draw lines
    ...
    for line in score_file:
        ...
        sort_value = score_dict.get(leader_board_sorter[0], "N/A")

        value = Jesey_ten.render(f"{name}:               {sort_value}", True, (255, 255, 255))
